...
function CollectionCard({
  ...
  return (
    <motion.div
      className={`relative group overflow-hidden rounded-sm ${item.span} min-h-[200px] md:min-h-[280px] cursor-pointer`}
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(105deg, transparent 40%, rgba(212,175,55,0.3) 45%, transparent 50%)",
